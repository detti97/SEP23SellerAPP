...
struct StoreDetailPreviewView: View {
	...
	@State var store = Setting(token: "", storeName: "", owner: "", street: "", houseNumber: "", zip: "", telephone: "", email: "", logo: "", backgroundImage: "https://images.ctfassets.net/uaddx06iwzdz/23fraOkNA2L2nYsNhqQePb/72d26aa66f33cca8b639f4ca4c344474/porsche-911-gt3-touring-front.jpg")
	...
	struct StoreDetail_Previews: PreviewProvider {
		static var previews: some View {
			Group{
				...
				let store = Setting(token: "", storeName: "Apple", owner: "Steve Jobs", street: "Apple Park", houseNumber: "1", zip: "49809", telephone: "123456", email: "jobs@apple.com", logo: "https://img.freepik.com/freie-ikonen/mac-os_318-10374.jpg", backgroundImage: "https://wallpapers.com/wp-content/themes/wallpapers.com/src/splash-n.jpg")
